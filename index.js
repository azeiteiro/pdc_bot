...
define("utils/googleAuth", ["require", "exports", "googleapis", "readline", "fs", "http", "http-terminator", "open", "utils/logger"], function (require, exports, googleapis_1, readline_1, fs_1, http_1, http_terminator_1, open_1, logger_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const googleAuth = () => {
...
define("utils/googlePhotosAPI", ["require", "exports", "fs", "utils/googleAuth", "utils/logger"], function (require, exports, fs_2, googleAuth_1, logger_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("utils/botCommands", ["require", "exports", "telegraf", "utils/googlePhotosAPI", "utils/logger", "utils/utils"], function (require, exports, telegraf_2, googlePhotosAPI_2, logger_4, utils_1) {
    ...
    const botCommands = (bot) => {
        ...
        bot.command('lineup', (ctx) => {
            ctx.reply('Please select the day', telegraf_2.Markup.inlineKeyboard(getDays().map((day) => telegraf_2.Markup.button.callback(`${new Date(day).toLocaleString('default', { weekday: 'long' })}`, `lineup-${day}`))));
        });
...
define("bots/mainBot", ["require", "exports", "telegraf", "utils/utils", "utils/botCommands", "../resources/commands.json"], function (require, exports, telegraf_3, utils_2, botCommands_1, commands_json_1) {
    ...
    const mainBot = (devMode = true) => {
        const { subscribeAlerts } = (0, utils_2.default)();
        const { env } = process;
        const createBot = () => {
